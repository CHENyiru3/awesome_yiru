...
- [**clawd-on-desk-streaming**](https://github.com/CHENyiru3/clawd-on-desk-streaming) — A coding-agent–aware **desktop pet** (e.g. Claude Code): reacts in real time (thinking, typing, idle, and similar); exploring productivity extras (translation, notifications, to-do, …). Active. *Last update: 2026-04-27.*
